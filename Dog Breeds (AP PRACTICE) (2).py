#Dog Breed Project (MOCK AP EXAM)
#2/27/25
#Xue Yong Li
...
#Functions
def getDogInformation():
    while True:
        x = input("Please enter your desired dog breed")
        try:
            y = dog_breeds.index(x)
        except:
            print("Dog breed not found, please try again!")
            continue
        print(str(x) + " temperaments are " + str(dog_temperament[y]) + ".")
        open_image(dog_images[y])
        break


def getDogPurpose():
    while True:
        x = input("What is your desired dog purpose?")
        try:
            for i in range(len(dog_purpose)):
                if x in dog_purpose[i]:
                    filtered_list.append(dog_breeds[i])
        except:
            print("Dog purpose not found, please enter a valid purpose.")
            continue
        print("Here are the dogs that have your desired purpose")
        print(filtered_list)
        break
...
def menu():
    global dog_breeds
    while True:
        print("Welcome to the Dog Breed Filter!")
        print("List of Dog Breeds:")
        print(dog_breeds)
        print("What would you like to do today?")
        print("""1. Dog Information
2. Dog Purpose
3. Dog Size Suggestion
4. Exit""")
        x = int(input("Choose what you would like to do"))
        if x == 1:
            print("list of temperaments")
        elif x == 3:
            getDogSize(input("What size would you like? ( tiny , small , medium, large )"))
        elif x == 2:
            print("Here are the list of dog purposes")
            print(dog_purpose)
            getDogPurpose()
        else:
            break
